(() => {
  ...
  function validateRecord(record) {
    ...
    const technical = new Set(["species","egg-count","nest-status","possible-renest","doc-photo-done","nest-one-m-photo-done","random-point-done","nest-substrate","nest-slope","nest-microrelief","random-rerolled","random-reroll-reason","random-substrate","random-slope","random-microrelief","meso-assessment-method","meso-big-objects","qc-bird-reaction","qc-time-at-nest","qc-aborted","qc-tracks","gps-accuracy","random-gps-accuracy","validation-override-summary"]);
